<template>
    <div style="height: 100%; overflow: hidden;" v-on:@keyup.alt.78="moveToNextAgenda">
        ...
        <div class="view-pane" style="margin-top: 86px; height: 100%; padding-top: 6px;">
            ...
            <div class="ui  grid" style="height: 100%;">
                ...
                <div class="ten wide column"
                    ...
                    <div class="toolbar"
                         style="text-align: center;border-bottom: 1px solid rgba(0,0,0,0.1);padding: 2px; ">
                        <button class="mini ui icon blue button" v-on:click="getToken">
                            <i class="cloud upload icon"></i> Upload Minutes
                        </button>
                        <button v-on:click="updateApp" v-if="updatable" class="mini ui icon red button">
                            <i class="cloud download icon"></i> Update Available !!
                        </button>
        ...
        <Token v-on:done="visible=false" :visible="visible"></Token>
    </div>
